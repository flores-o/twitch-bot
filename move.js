...
const channel = 'quinnmusk';  // Replace with your channel.
const account = 'gptyy';   // Replace with the account the bot runs as
const password = require("./password.js");

const moveMessage = 'Get up and move, your body will thank you! Message updated';
const defaultMoveInterval = 1000 * 60 * 0.5; // Set to 1 minute for testing.
